...
export const LanguageProvider = ({ children }) => {
  ...
  const translations = {
    en: {
      ...
      timelineDescription: "The path that shaped my skills and passion for technology.",
    },
    fr: {
      // Hero Section
      ...
      timelineDescription: "Le chemin qui a façonné mes compétences et ma passion pour la technologie.",
    }
  };
